...
_MOCK_RULES: list[tuple[str, str]] = [
    ("MERCADONA", "alimentacion"), ("CARREFOUR", "alimentacion"),
    ("LIDL", "alimentacion"), ("DIA", "alimentacion"), ("ALCAMPO", "alimentacion"),
    ("MCDONALD", "restauracion"), ("BURGER", "restauracion"),
    ("RESTAURANTE", "restauracion"), ("BAR ", "restauracion"), ("CAFE", "restauracion"),
    ("GLOVO", "restauracion"), ("UBER EATS", "restauracion"),
    ("UBER", "transporte"), ("CABIFY", "transporte"), ("RENFE", "transporte"),
    ("METRO", "transporte"), ("EMT", "transporte"), ("REPSOL", "transporte"),
    ("CEPSA", "transporte"), ("GASOLINERA", "transporte"), ("PARKING", "transporte"),
    ("NETFLIX", "suscripciones"), ("SPOTIFY", "suscripciones"),
    ("HBO", "suscripciones"), ("AMAZON PRIME", "suscripciones"),
    ("DISNEY", "suscripciones"), ("ICLOUD", "suscripciones"),
    ("CINE", "ocio"), ("TEATRO", "ocio"), ("STEAM", "ocio"), ("PLAYSTATION", "ocio"),
    ("ZARA", "compras"), ("AMAZON", "compras"), ("EL CORTE INGLES", "compras"),
    ("MEDIAMARKT", "compras"), ("PRIMARK", "compras"),
    ("IBERDROLA", "hogar"), ("ENDESA", "hogar"), ("NATURGY", "hogar"),
    ("MOVISTAR", "hogar"), ("VODAFONE", "hogar"), ("ORANGE", "hogar"),
    ("ALQUILER", "hogar"), ("COMUNIDAD", "hogar"),
    ("FARMACIA", "salud"), ("CLINICA", "salud"), ("HOSPITAL", "salud"),
    ("DENTISTA", "salud"), ("SANITAS", "salud"),
    ("TRANSFERENCIA", "transferencias"), ("BIZUM", "transferencias"),
    ("NOMINA", "ingresos"), ("SALARIO", "ingresos"), ("ABONO", "ingresos"),
    ("AEAT", "impuestos_tasas"), ("HACIENDA", "impuestos_tasas"),
    ("IMPUESTO", "impuestos_tasas"), ("TASA", "impuestos_tasas"),
]
